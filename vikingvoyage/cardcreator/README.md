...
- **Three rooms:** *Card Creator* (leaders, starting decks, specialists + signature cards,
  enemies — same class→members shape as specialists, but enemies have no cards at all:
  each carries a list of telegraphed abilities, and they never roll — tactics, negative
  cards, consumables), *Card Anatomy* (the shared template — colours,
