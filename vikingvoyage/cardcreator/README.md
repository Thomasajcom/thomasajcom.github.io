...
- **Two rooms:** *Card Anatomy* (the shared template — colours, plates, frame, type) and
  *Card Creator* (leaders, starting decks, specialists + signature cards, tactics, negative
  cards, consumables).
